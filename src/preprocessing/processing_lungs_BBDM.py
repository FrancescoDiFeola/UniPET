...
# ====== Main Script ======
csv_path = "/mimer/NOBACKUP/groups/snic2022-5-277/piacente/IMMAGINI_TEST/WHOLE_BODY/lungs_only/test.csv"  # train_whole_body_with_pathology.csv
ct_folder = "/mimer/NOBACKUP/groups/snic2022-5-277/piacente/IMMAGINI_TEST/WHOLE_BODY/SORTED+GROUPED+WARMUP_FRA"
pet_gen_folder = "/mimer/NOBACKUP/groups/naiss2023-6-336/sarita/Diffusion_Results/100PET_results_lung_Nifti/lung"
output_folder = "/mimer/NOBACKUP/groups/naiss2023-6-336/sarita/Diffusion_Results/100PET_results_lung_Nifti"
seg_folder = "/mimer/NOBACKUP/groups/snic2022-5-277/piacente/IMMAGINI_TEST/seg/"
...
for _, row in tqdm(df.iterrows()):
    ...
    pet_orig_path = os.path.join(ct_folder, f"original_image_{unique_number}.nii.gz")
    pet_gen_path = os.path.join(pet_gen_folder, f"{subject_id}_generated.nii.gz")
    seg_path = os.path.join(seg_folder, f"{unique_number}_SEG.nii.gz")
